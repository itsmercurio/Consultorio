...
public class LoginAmansilla extends javax.swing.JFrame {
    ...
    public static String[] recuperarDatosAmansilla;

    public void acceso() {
        try {
            us = campoUsuario.getText();
            pass = new String(campoContrasena.getPassword());
            
            ConexionAmansilla.conectarAmansilla();
            if (ConexionAmansilla.accederAmansilla(us, pass)) {
                recuperarDatosAmansilla = ConexionAmansilla.recuperarDatosUserLogadoAmansilla(us);
                ConexionAmansilla.cerrarConexionAmansilla();
                MenuPrincipalAmansilla p = new MenuPrincipalAmansilla();
                p.setVisible(true);
                this.dispose();
            ...
            Logger.getLogger(LoginAmansilla.class.getName()).log(Level.SEVERE, null, ex);
